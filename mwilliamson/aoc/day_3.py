def main():
    assert closest_intersection_distance_by_manhattan_distance("R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83") == 159
    assert closest_intersection_distance_by_manhattan_distance("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7") == 135
    print(part_1())

    assert closest_intersection_distance_by_step_count("R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83") == 610
    assert closest_intersection_distance_by_step_count("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7") == 410
    print(part_2())
...
def part_1():
    ...
    return closest_intersection_distance_by_manhattan_distance(path_1, path_2)
...
def part_2():
    ...
    return closest_intersection_distance_by_step_count(path_1, path_2)
...
def closest_intersection_distance_by_step_count(path_1, path_2):
    ...
    def step_count(location):
        return step_counts_by_location_1[location] + step_counts_by_location_2[location]

    return min(map(step_count, intersections))
